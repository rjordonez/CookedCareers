      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-[#1a1a1a] rounded-3xl p-12 text-center">
          ...
          <div className="flex items-center justify-center gap-4 flex-wrap">
            <Link to="/auth">
              <Button size="lg" className="rounded-full font-medium px-10 h-14 shadow-lg hover:shadow-xl transition-shadow bg-white text-black hover:bg-gray-100">
                Join Now →
              </Button>
            </Link>
            <a href="https://calendly.com/jessie-nativespeaking/consultation-call" target="_blank" rel="noopener noreferrer">
              <Button size="lg" variant="outline" className="rounded-full font-medium px-10 h-14 border-gray-600 text-white hover:bg-white/10">
